...
namespace CItyCenterSystem.Areas.Account.Controllers
{
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    return RedirectToAction("Login", "Account", new { message = "The User" + model.UserName + "Has been created successfully." });
                }
                AddErrors(result);
            }
            return View(model);
        ...
        public async Task<IActionResult> RecoveryPassword(RecoveryPasswordViewModel vm)
        {
            ...
            MailMessage mm = new MailMessage
            {
                ...
                From = new MailAddress("test.fibonacci06@gmail.com")
            };
            mm.To.Add(to);
            SmtpClient smtp = new SmtpClient("smtp.gmail.com")
            {
                ...
                EnableSsl = true,
                Credentials = new NetworkCredential("test.fibonacci06@gmail.com", "Fibonacci@123Qwerty"),
            };
            smtp.Send(mm);
        ...
        public async Task<IActionResult> ChangePassword(ChangePasswordViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var result = await _userManager.ChangePasswordAsync(user, HttpUtility.UrlDecode(model.Token), model.NewPassword);
