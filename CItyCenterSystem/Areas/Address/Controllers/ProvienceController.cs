        ...
        public async Task<IActionResult> Update(ProvienceDto dto)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    return RedirectToAction("Index", "Provience", new { message = "Provience has been update successfully." });
                }
                else
                {
                    ViewBag.Message = "Error: Invalid data !";
        ...
        public async Task<IActionResult> DeleteConfirmed(Provience provience)
        {
            try
            {
                if (provience != null)
                {
                    ...
                    return RedirectToAction("Index", "Provience", new { messege = "Provience has been delete successfully." });
                }
            }
            catch (Exception ex)
            {
