...
namespace CItyCenterSystem.Areas.Address.Controllers
{
    public class LocalLevelController : Controller
    {
        ...
        public async Task<IActionResult> Index(LocalLevelViewModel vm,string message, string messege)
        {
        ...
        public async Task<IActionResult> Update(LocalLevelDto dto)
        {
            try
            {
                if (ModelState.IsValid)
                {
                    ...
                    return RedirectToAction("Index", "LocalLevel", new { message = "Local Level has been update successfully." });
                }
                else
                {
                    ViewBag.Message = "Error: Invalid data !";
        ...
        public async Task<IActionResult> DeleteConfirmed(LocalLevel localLevel)
        {
            try
            {
                if (localLevel != null)
                {
                    ...
                    return RedirectToAction("Index", "LocalLevel", new { messege = "Local Level has been delete successfully." });
                }
            }
            catch (Exception ex)
            {
